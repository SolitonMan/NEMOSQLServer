...
class User(models.Model):
	...
	# Permissions
	is_active = models.BooleanField(verbose_name='active', default=True, help_text='Designates whether this user can log in to NEMO. Unselect this instead of deleting accounts.')
	is_staff = models.BooleanField(verbose_name='staff status', default=False, help_text='Designates whether the user can log into this admin site.')
	is_technician = models.BooleanField(verbose_name='technician status', default=False, help_text='Specifies how to bill staff time for this user. When checked, customers are billed at technician rates.')
...
class Tool(models.Model):
	...
	primary_owner = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="primary_tool_owner", help_text="The staff member who is responsible for administration of this tool.")
	...
	# Policy fields:
	requires_area_access = models.ForeignKey('Area', on_delete=models.SET_NULL, null=True, blank=True, help_text="Indicates that this tool is physically located in a billable area and requires an active area access record in order to be operated.")
	grant_physical_access_level_upon_qualification = models.ForeignKey('PhysicalAccessLevel', on_delete=models.SET_NULL, null=True, blank=True, help_text="The designated physical access level is granted to the user upon qualification for this tool.")
	...
	interlock = models.OneToOneField('Interlock', on_delete=models.SET_NULL, blank=True, null=True)
...
class StaffCharge(CalendarDisplay):
	...
	customer = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='staff_charge_customer')
	project = models.ForeignKey('Project', on_delete=models.SET_NULL, null=True)
...
class UsageEvent(CalendarDisplay):
	user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="usage_event_user")
...
class StockroomItem(models.Model):
	name = models.CharField(max_length=100)
	category = models.ForeignKey('StockroomCategory', on_delete=models.SET_NULL, blank=True, null=True)
	quantity = models.IntegerField(help_text="The number of items currently in stock.")
...
class StockroomWithdraw(models.Model):
	customer = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="stockroom_user", help_text="The user who will use the stockroom item.")
	merchant = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="stockroom_merchant", help_text="The staff member that performed the withdraw.")
	stock = models.ForeignKey(StockroomItem, on_delete=models.SET_NULL, null=True)
	quantity = models.PositiveIntegerField()
	project = models.ForeignKey(Project, on_delete=models.SET_NULL, null=True, help_text="The withdraw will be billed to this project.")
	date = models.DateTimeField(default=timezone.now, help_text="The date and time when the user withdrew the consumable.")
